<x-app-layout>
    ...
    <main
        class="mt-5 h-auto flex flex-col content-center items-center justify-around rounded-lg p-4 pt-20 dark:bg-gray-700 md:ml-20">
                ...
                <div>
                    ...
                    <form class="p-4 md:p-5" action="{{ route('donation.new') }}" method="POST">
                        ...
                        <div class="mb-4 grid grid-cols-2 gap-4" id="member_donation">
                            @if ($members->count() == 0)
                                <a href="{{ route('member.create') }}" <p
                                    class="col-span-2 mb-4 rounded-md bg-red-50 p-2 text-center text-red-500">
                                    Click here to register a member before you can receive donations from a member
                                    </p>
                                </a>
                            @else
