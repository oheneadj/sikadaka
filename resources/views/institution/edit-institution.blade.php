                    ...
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Type institution name" value="{{ old('name', $institution->name) }}">
                            @error('name')
                                <small class="text-xs font-bold text-red-500">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="slogan" id="slogan"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                placeholder="Type institution slogan" value="{{ old('slogan', $institution->slogan) }}">
                            @error('slogan')
                                <small class="text-xs font-bold text-red-500">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="email" name="email" id="email"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                placeholder="example@email.com" value="{{ old('email', $institution->email) }}">
                            @error('email')
                                <small class="text-xs font-bold text-red-500">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-span-2">
                            <label for="address"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Community Address
                                Address</label>
                            <input type="text" name="address" id="address"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                placeholder="Type community address"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="number" name="male_amount" id="male_amount"
                                ...
                                value="{{ old('male_amount', $institution->male_amount) }}">
                            @error('male_amount')
                                <small class="text-xs font-bold text-red-500">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="number" name="female_amount" id="female_amount"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                placeholder="Enter an amount"
                                value="{{ old('female_amount', $institution->female_amount) }}">
                            @error('female_amount')
                                <small class="text-xs font-bold text-red-500">
                                    {{ $message }}
                                </small>
