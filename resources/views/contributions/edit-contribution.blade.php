<x-app-layout>
    ...
    <main class="flex h-auto items-center justify-center p-4 pt-20 dark:bg-gray-700 md:ml-20">
            ...
            <div class="rounded-md bg-white p-3">
                ...
                <form class="p-4 md:p-5" action="{{ route('payment.update', $contribution->id) }}" method="POST">
                    ...
                    <button id="submit" type="submit"
                        class="inline-flex w-full items-center justify-center rounded-lg bg-black px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:bg-blue-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
